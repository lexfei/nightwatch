// Package filters provides API to implement nightwatch filters.
package filters
...
type Filter interface {
	// Init is called when nightwatch starts monitoring.
	Init()
...
// This function is used internally in nightwatch.
